        ...
        <Dialog as="div" className='relative z-10' onClose={closeModal}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                   <Dialog.Panel className="relative w-full max-w-lg max-h-[92vh] 
                   overflow-y-auto transform rounded-2x1 bg-white p-6 text-left shadow-xl 
                   transition-all flex flex-col gap-5 ">
                    ...
                    <div className="flex-1 flex flex-col gap-3">
                        ...
                        <div className='flex gap-3'>
                            ...
                            <Image src="/Toyota-1.png" alt='car model'
                            fill priority className='object-contain'/>
                            ...
                            <Image src="/Toyota-2.png" alt='car model'
                            fill priority className='object-contain'/>
                            ...
                            <Image src="/Toyota-3.png" alt='car model'
                            fill priority className='object-contain'/>
